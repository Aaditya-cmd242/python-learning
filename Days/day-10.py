...
# looks like set but written as frozenset({...})
...
- not hashable
- cannot be element of another set
...
***************************************************************
👉 There is no literal syntax for frozenset (like {} for set) *
                                                              *
